...
ExecutionState::ExecutionState(const ExecutionState& state):
    ...
    kdefault_space(state.kdefault_space),
    k_espace(state.k_espace),
    kfor_beg(state.kfor_beg),
    kfor_end(state.kfor_end),
    kfor_idx1(state.kfor_idx1),
    kfor_idx2(state.kfor_idx2),
    kview_accesses(state.kview_accesses),
    kview_writes(state.kview_writes),
    kview_states(state.kview_states) {
  for (const auto &cur_mergehandler: openMergeStack)
