...
#define HANDLER(name) void name(ExecutionState &state, \
    ...
    HANDLER(handleOnViewCreate);
    HANDLER(handleOnViewMirror);
    HANDLER(handleOnViewReference);
    HANDLER(handleOnDeepCopy);
    HANDLER(handleForInitialize);
    HANDLER(handleKokkosInitialize);
    HANDLER(handleKokkosFinalize);
    HANDLER(handleForFinalize);
    HANDLER(handleViewDeepCopy);
#undef HANDLER
  };
} // End klee namespace
